...
#define VGA_WIDTH   100		//Displayable area (Width)
#define VGA_HEIGHT  73		//Displayable area (Height)
#define VGA_LBUFFER 100		//Local Video RAM buffer (Width)
#define VGA_VBUFFER 75		//Local Video RAM buffer (Height)

#define VGA_LBUFFERSIZE 128	//Circular DMA RAM bufer (1-line)
#define VGA_FULL	2048
#define VGA_HALF	1024
